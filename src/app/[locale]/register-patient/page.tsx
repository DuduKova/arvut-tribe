...
export default function RegisterPatientForm() {
  ...
  const steps = [
    ...
    {
      title: locale === 'he' ? 'רקע רפואי ופיזי' : 'Medical and Physical Background',
      titleEn: 'Medical Background'
    },
    {
      title: locale === 'he' ? 'היסטוריה טיפולית ונפשית' : 'Therapeutic and Mental History',
      titleEn: 'Mental History'
    },
    {
      title: locale === 'he' ? 'הכוונה, תמיכה ומוכנות' : 'Guidelines, Support, and Readiness',
          ...
          {currentStep === 0 && !formData.privacyConsent && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">
                {locale === 'he' ? 'הודעת פרטיות והסכמה' : 'Privacy Notice and Consent'}
              </h3>
              <div className="text-sm text-gray-700 mb-4 space-y-2">
                {locale === 'he' ? (
                  <>
                    <p>מידע זה נאסף למטרות רפואיות וטיפוליות בלבד ויישמר בסודיות מלאה.</p>
                    <p>הנתונים שלך מאובטחים ומוגנים בהתאם לתקנות הגנת הפרטיות והיפא (HIPAA).</p>
                    <p>רק צוות מקצועי מורשה יוכל לגשת למידע שלך.</p>
                  </>
                ) : (
                  <>
                    <p>This information is collected for medical and therapeutic purposes only and will be kept strictly confidential.</p>
                    <p>Your data is secured and protected in accordance with privacy regulations and HIPAA.</p>
                    <p>Only authorized professional staff will have access to your information.</p>
                  </>
                )}
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' ? 'הכנס את מספר הטלפון שלך' : 'Enter your phone number'}
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' ? 'הכנס את עיר מגוריך' : 'Enter your city of residence'}
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateField('chronicIllnesses', e.target.value)}
                      rows={6}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateField('mentalTreatment', e.target.value)}
                      rows={6}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' 
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateField('previousRetreats', e.target.value)}
                      rows={6}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' 
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateField('ptsdDiagnosis', e.target.value)}
                      rows={6}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' 
                        ? 'פרטי האבחנה, תקופה, גורם מאבחן...'
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateField('psychiatricMedication', e.target.value)}
                      rows={6}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' 
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateField('addictions', e.target.value)}
                      rows={6}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' 
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => updateField('reasonForHealing', e.target.value)}
                      rows={6}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder={locale === 'he' 
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        { value: 'not-at-all', labelHe: 'לא בכלל', labelEn: 'Not at all' },
                        { value: 'a-little', labelHe: 'מעט', labelEn: 'A little' },
                        { value: 'medium', labelHe: 'בינוני', labelEn: 'Medium' },
                        { value: 'a-lot', labelHe: 'הרבה', labelEn: 'A lot' },
                        { value: 'completely', labelHe: 'לחלוטין', labelEn: 'Completely' }
                      ].map((option) => (
